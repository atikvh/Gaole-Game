...
public class Electric extends Pokemon {
	...
	public Electric(String name, String type, String skillone, String skilltwo, int HP)
	{
	...
	public void reducePokemonHP(int HPdamage) {
		if ("Ice".equals(moveType)&&"Water".equals(moveType)&&"Grass".equals(moveType)&&"Fire".equals(moveType)) {
			//normalEffect
			double damage = HPdamage*0.75;
			hitPoint -= damage;
		}
		if ("Electric".equals(moveType)) {
			//not very effective
