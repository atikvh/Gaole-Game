...
public class Fire extends Pokemon {
	...
	public Fire(String name, String type, String skillone, String skilltwo, int HP)
	{
		moveType = type = "Fire";
		firstSkill = skillone;
	...
	@Override
	 public void reducePokemonHP(int HPdamage) {
		...
		if ("Ice".equals(moveType)&&"Grass".equals(moveType)&&"Fire".equals(moveType)) {
			//not very effective
			double damage = HPdamage*0.25;
			hitPoint -= damage;
		}
		if ("Water".equals(moveType)) {
			//super effective
